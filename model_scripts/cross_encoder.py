...
with open('/home/dghilardi/kgqa/mention-clustering/model_scripts/config_crossencoder/config_train.yaml', 'r') as f:
...
# Checkpoint testing
#model = CrossEncoder.load_from_checkpoint("/home/dghilardi/kgqa/mention-clustering/biencoder/zeshel/CrossEncoder/epoch=0-step=2327.ckpt")
#x = 0