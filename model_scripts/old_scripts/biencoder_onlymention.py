...
from module.biencoder import BiEncoderOnlyMention
...
biencoder_model = BiEncoderOnlyMention(config['context_encoder'], config['optimizer'], config['loss'], config['miner'], config['knn_search'])
...
biencoder_data.setup()
trainer.test(biencoder_model, biencoder_data.val_dataloader())
